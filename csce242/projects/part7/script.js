...
document.getElementById('contactForm').addEventListener('submit', async function(event) {
    ...
    const formData = new FormData(this); // collects form info
    ...
    try {
        ...
        if (response.ok) {
            document.getElementById('formSuccess').style.display = 'block'; // showing success message
            document.getElementById('formError').style.display = 'none'; // hide error message
        } else {
            document.getElementById('formError').style.display = 'block'; // showing error message
            document.getElementById('formSuccess').style.display = 'none'; // hide success message
        }
    } catch (error) {
        document.getElementById('formError').style.display = 'block'; // showing error message
        document.getElementById('formSuccess').style.display = 'none'; // hiding success message
    }
});